...
Stage::Stage()
{
    ...
    init_pair(GROWTH_ITEM, COLOR_BLACK, COLOR_BLUE);
...
void Stage::setMission()
{
    ...
    statMission[0] = rand() % 5 + 6;
    statMission[1] = rand() % 5 + 4;
    statMission[2] = rand() % 4 + 3;
    statMission[3] = rand() % 5 + 1; 
}
